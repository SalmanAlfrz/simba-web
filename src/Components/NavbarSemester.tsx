...
export default function NavbarSemester(){
    return (
        <Stack spacing={1} mt={10} float='right'>
            <img src={background} style={{height:'100px',marginBottom:'50px'}}/>
            ...
            <Link to='/semester'><Button justifyContent="flex-start" backgroundColor="#EDECF8" color="#6867AC" w={180} style={{height:'50px'}}><img src={icon_semester_active} width={21} height={21} alt="" /><Text fontSize='lg' pl={3} ><b>Semester</b></Text></Button></Link>
            <Link to='/kegiatan'><Button justifyContent="flex-start" backgroundColor="#ffffff" color="#6D7878" w={180} style={{height:'50px'}}><img src={icon_subjects_active} width={21} height={21} alt="" /><Text fontSize='lg' pl={3} ><b>Kegiatan</b></Text></Button></Link>
